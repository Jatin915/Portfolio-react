...
export const About = () => {
  return (
    <section id="about" className="min-h-[calc(100vh-80px)] min-w-full backdrop-blur-3xl shadow-sm bg-slate-100 sm:flex sm:flex-row sm:justify-center sm:px-20 pt-20 pb-5 flex flex-col items-center dark:bg-gray-950 transition duration-300">
