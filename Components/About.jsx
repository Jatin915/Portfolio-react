  ...
  return (
    <section id="about" className="min-h-[calc(100vh)] min-w-full backdrop-blur-3xl shadow-sm bg-slate-100 sm:flex sm:flex-row sm:justify-center sm:px-20 pt-20 pb-5 flex flex-col items-center dark:bg-gray-950 transition duration-300">
      <div id="about-left-container" className="max-h-fit w-[80vw] sm:w-[60vw] xl:max-w-[50vw] lg:mr-32 sm:mr-16">
        ...
        <button id="btn" className="h-12 min-w-full sm:min-w-fit bg-blue-500 px-6 rounded-md text-white mr-4 mb-4 transition-transform duration-300 ease-in-out cursor-pointer">Contact Me</button>
        <button id="btn" className="h-12 min-w-full sm:min-w-fit border-slate-400 border-[0.5px] px-6 rounded-md text-gray-600 dark:text-gray-300 dark:bg-transparent transition-all duration-300 ease-in-out cursor-pointer">Download Resume</button>
      </div>
