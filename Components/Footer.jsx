...
//         <div><Link to="/hero"><strong><h2 className="text-3xl dark:text-white transition duration-300">Jatin.dev</h2></strong></Link></div>
        
//         <div>
//           <ul className="flex gap-3 sm:gap-4 md:gap-6 text-gray-700 dark:text-gray-400 text-sm sm:text-[1rem] transition duration-300">
